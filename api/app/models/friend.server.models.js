...
const add_friend = (user_id, friend_id, done) => {
    ...
    const query = `INSERT INTO spacebook_friends (friend_user_id, friend_friend_id, status) VALUES (${  user_id  },${  friend_id  },"REQUESTED")`;
...
const accept_friend_request = (user_id, friend_id, done) => {
    ...
    const query = `UPDATE spacebook_friends SET status="CONFIRMED" WHERE friend_user_id=${  friend_id  } AND friend_friend_id=${  user_id  } AND status="REQUESTED"`;
...
const delete_friend_request = (user_id, friend_id, done) => {
    ...
    const query = `DELETE FROM spacebook_friends WHERE friend_user_id=${  friend_id  } AND friend_friend_id=${  user_id  } AND status="REQUESTED"`;
